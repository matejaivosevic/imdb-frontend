...
import { LOGIN, REGISTER, GET_MOVIES, LOGOUT, GET_MOVIE, GET_MOVIES_BY_TITLE, LIKE_MOVIE, LIKE_MOVIE_ON_SINGLE_PAGE, GET_MOVIES_BY_GENRE, VISIT_MOVIE, ADD_COMMENT, GET_ALL_COMMENTS, ADD_TO_WATCH_LIST_SINGLE_PAGE, ADD_TO_WATCH_LIST, GET_WATCH_LIST, GET_POPULAR, GET_RELATED, CREATE_MOVIE, GET_GENRES } from '../actions/ActionTypes';
import { userLogin, userLogout, userRegister } from './AuthSagas';
import { addToWatchList, addToWatchListSinglePage, commentAdd, commentsGet, genresGet, movieCreate, movieGet, movieLike, movieOnSinglePageLike, moviesGet, moviesGetByGenre, moviesGetByTitle, movieVisit, popularGet, relatedGet, watchListGet } from './MovieSagas';
