...
import { LOGIN, REGISTER, GET_MOVIES, LOGOUT, GET_MOVIE, GET_MOVIES_BY_TITLE, LIKE_MOVIE, LIKE_MOVIE_ON_SINGLE_PAGE, GET_MOVIES_BY_GENRE, VISIT_MOVIE } from '../actions/ActionTypes';
import { userLogin, userLogout, userRegister } from './AuthSagas';
import { movieGet, movieLike, movieOnSinglePageLike, moviesGet, moviesGetByGenre, moviesGetByTitle, movieVisit } from './MovieSagas';
